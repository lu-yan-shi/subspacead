...
from transformers.utils import TransformersKwargs, auto_docstring, torch_int, logging
...
def eager_attention_forward(
    ...
    **kwargs: Unpack[TransformersKwargs],
    ...
    attn_weights_b4softmax = attn_weights.clone()
    ...
    return attn_output, attn_weights_b4softmax
...
class Dinov2WithRegistersAttention(nn.Module):
    ...
    def forward(
        ...
        self_attn_output, attn_weights = self.attention(hidden_states, output_attentions=output_attentions)
...
class Dinov2WithRegistersLayer(GradientCheckpointingLayer):
    ...
    def forward(
        ...
        self_attention_output, attention_weights = self.attention(
            hidden_states_norm, 
...
class Dinov2WithRegistersEncoder(nn.Module):
    ...
    def forward(
        ...
        last_idx = len(self.layer) - 1
        for i, layer_module in enumerate(self.layer):
            hidden_states, attention_weights = layer_module(
                hidden_states,
                output_attentions=output_attentions and i == last_idx
            )
